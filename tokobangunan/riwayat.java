...
public class riwayat extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cb_riwayat = new javax.swing.JComboBox<>();
        ...
        txt_keterangan.setText("Transaksi > Riwayat ");
        ...
        cb_riwayat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Riwayat Pembelian", "Riwayat Penjualan" }));
        cb_riwayat.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        cb_riwayat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cb_riwayatActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(cb_riwayat, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cb_riwayat, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );

        tabel_riwayat.setBackground(new java.awt.Color(226, 216, 216));
        tabel_riwayat.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "Id Barang", "Nama Barang", "Jumlah", "Harga Satuan"
            }
        ) {
        ...
        tabel_riwayat.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        tabel_riwayat.setSelectionForeground(new java.awt.Color(63, 57, 57));
    ...
    private void cb_riwayatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_riwayatActionPerformed
        try {
            java.sql.Connection conn = (Connection)config.configDB();
                if (cb_riwayat.getSelectedIndex()==0) {
                    loadTablePembelian();
                } else {
                    loadTablePenjualan();
                }
    ...
    }//GEN-LAST:event_cb_riwayatActionPerformed
    ...
    public static javax.swing.JComboBox<String> cb_riwayat;
    ...
    private void loadTablePembelian() {
        // membuat tampilan table
        DefaultTableModel model = new DefaultTableModel();
        // membbuat tampilan nama kolom
        model.addColumn("No");
        model.addColumn("Id Pembelian");
        model.addColumn("Penanggung Jawab");
        model.addColumn("Nama Barang");
        model.addColumn("Riwayat");
        // memanggil data di SQL
        try {
            // atur nomer urut baris pada kolom Nomer
            int no = 1;
            // query sql
            String SQL = "SELECT detail_pembelian.id_pembelian, pegawai.nama_pegawai, barang.nama_barang, pembelian.tanggal "
                    + "FROM pegawai "
                    + "JOIN pembelian "
                    ...
                    + "JOIN barang "
                    + "ON barang.id_barang = detail_pembelian.id_barang ORDER BY tanggal DESC";
            java.sql.Connection conn = (Connection)config.configDB();
    ...
    private void loadTablePenjualan() {
        ...
        try {
            ...
            int no = 1;
            // query sql
            String SQL = "SELECT detail_penjualan.id_penjualan, pegawai.nama_pegawai, barang.nama_barang, penjualan.tanggal "
                    + "FROM pegawai "
                    + "JOIN penjualan "
                    + "ON penjualan.id_pegawai = pegawai.id_pegawai "
                    + "JOIN detail_penjualan "
                    + "ON penjualan.id_penjualan = detail_penjualan.id_penjualan "
                    + "JOIN barang "
                    + "ON barang.id_barang = detail_penjualan.id_barang ORDER BY tanggal DESC";
            java.sql.Connection conn = (Connection)config.configDB();
            java.sql.Statement stm = conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(SQL);
            while (res.next()) {
