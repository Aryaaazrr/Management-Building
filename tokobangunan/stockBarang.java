...
public class stockBarang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabel_stockBarang = new javax.swing.JTable();
        ...
        txt_keterangan.setText("Laporan > Stock Barang");
        ...
        tabel_stockBarang.setBackground(new java.awt.Color(226, 216, 216));
        tabel_stockBarang.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tabel_stockBarang.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        tabel_stockBarang.setSelectionForeground(new java.awt.Color(63, 57, 57));
        jScrollPane1.setViewportView(tabel_stockBarang);
        ...
        getContentPane().add(btn_logout, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 460, 50, 40));
    ...
    private javax.swing.JTable tabel_stockBarang;
    ...
    private void loadTable() {
        ...
        try {
            int no = 1;
            String SQL = "SELECT id_barang, nama_barang, stok, satuan FROM barang;";
            ...
            tabel_stockBarang.setModel(model);
        } catch (Exception e) {
        }
    }
